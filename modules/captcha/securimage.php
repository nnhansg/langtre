...
/**
 ChangeLog by ApPHP
    1. [06.06.2011] - fixed bug with unexisting var $code in validate() method
...
class Securimage {
	...
	*/
	...
	function Securimage()
	{
		...
		$this->perturbation       = 0.45;
		$this->iscale             = 5;
		$this->text_angle_minimum = -9;
		$this->text_angle_maximum = 9;

		$this->image_bg_color   = new Securimage_Color(0xf5, 0xf5, 0xee);
        $this->text_color       = new Securimage_Color(0x5d, 0x7d, 0x9d);
        //0a68dd,#f65c47,#8d32fd
		$this->multi_text_color = array(new Securimage_Color(0x0a, 0x68, 0xdd),
                                        ...
                                        new Securimage_Color(0x30, 0x60, 0x9a),
                                        new Securimage_Color(0x00, 0x60, 0xCC),
                                        new Securimage_Color(0x00, 0x60, 0x00));
		...
		$this->num_lines            = 6;
		$this->line_color           = new Securimage_Color(0xb0, 0xc0, 0xd0);
		$this->draw_lines_over_text = false;

		$this->image_signature = '';
		$this->signature_color = new Securimage_Color(0x0, 0x50, 0xCC);
